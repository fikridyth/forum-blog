...
<?php $__env->startSection('container'); ?>
    ...
    <?php if($posts->count()): ?>
        <div class="card mb-3">
            ...
            <?php else: ?>
                <img src="https://source.unsplash.com/1200x400?<?php echo e($posts[0]->category->name); ?>" class="card-img-top"
            ...
            <div class="card-body text-center">
                ...
                <p>
                    <small class="text-muted">
                        By. <a href="/posts?author=<?php echo e($posts[0]->author->username); ?>"
                            class="text-decoration-none"><?php echo e($posts[0]->author->name); ?></a> in
                ...
                <a href="/posts/<?php echo e($posts[0]->slug); ?>" class="btn btn-success">Read More</a>
            </div>
        </div>
            ...
            <div class="row">
                <?php $__currentLoopData = $posts->skip(1); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-md-3 mb-3">
                        <div class="card">
                            <div class="position-absolute bg-dark px-3 py-1" style="background-color: rgba(0,0,0,0.5)"><a
                                    href="/posts?category=<?php echo e($post->category->slug); ?>"
                                    class="text-white text-decoration-none">
                                    <?php echo e($post->category->name); ?></a></div>
                            <?php if($post->image): ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\fikro\Documents\Project\Laravel\fblog\resources\views/posts.blade.php ENDPATH**/ ?>