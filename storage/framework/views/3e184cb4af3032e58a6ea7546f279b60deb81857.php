...
unset($__errorArgs, $__bag); ?>" id="title" name="title"
                    autofocus value="<?php echo e(old('title', $post->title)); ?>">
...
<script>
    // Mendisable fitur attach file dari trix box
...
<?php echo $__env->make('dashboard.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\fikro\Documents\#Laravel & htdocs\fblog\resources\views/dashboard/posts/edit.blade.php ENDPATH**/ ?>