        ...
        <div class="row justify-content-center mb-5">
            <div class="col-md-8">
                ...
                <ul class="list-unstyled activity-list">
                    <?php $__currentLoopData = $post->comment()->where('parent', 0)->orderBy('created_at', 'desc')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li>
                            <p style="padding-left: 0.2em;">
                                <a href="#" class="text-decoration-none"><?php echo e($comment->user_name); ?></a> <small
                            ...
                            <form action="" method="POST" style="display:none; margin-bottom:-10px;" id="sub-comment">
                                <?php echo csrf_field(); ?>
                                <input type="hidden" name="post_id" value="<?php echo e($post->id); ?>">
                                <input type="hidden" name="parent" value="<?php echo e($comment->id); ?>">
                                <input type="text" style="margin-top:-6px;" name="content" class="form-control">
                                <input type="submit" style="margin-top:3px;" class="btn btn-success" value="Kirim">
                            </form><br>

                            <h5 style="padding-left: 1em;">Reply</h5>
                            <p style="padding-left: 1.8em; margin-top:10px;">
                                <?php $__currentLoopData = $comment->childs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $child): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <a href="#" class="text-decoration-none"><?php echo e($child->user_name); ?></a> <small
                                        class="text-muted"><?php echo e($child->created_at->diffForHumans()); ?></small> <br>
                                    <?php echo e($child->content); ?> <br> <br>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\fikro\Documents\#Laravel & htdocs\fblog\resources\views/post.blade.php ENDPATH**/ ?>